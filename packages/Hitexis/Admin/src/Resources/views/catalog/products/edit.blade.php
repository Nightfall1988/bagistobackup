            ...
            @foreach ($product->attribute_family->attribute_groups->groupBy('column') as $column => $groups)
                ...
                <div class="flex flex-col gap-2 {{ $column == 1 ? 'flex-1 max-xl:flex-auto' : 'w-[360px] max-w-full max-sm:w-full' }}">
                    @foreach ($groups as $group)
                            ...
                            <div class="box-shadow relative rounded bg-white p-4 dark:bg-gray-900">
                                ...
                                @foreach ($customAttributes as $attribute)
                                    ...
                                    <x-admin::form.control-group class="last:!mb-0">
                                        ...
                                        @include ('hitexis-admin::catalog.products.edit.controls', [
                                            'attribute' => $attribute,
                                            'product'   => $product,
                                        ])
                        ...
                        @endif
                    @endforeach
                    @include('hitexis-admin::catalog.components.markup.markup-manager',  ['product' => $product])
                    ...
                    @if ($column == 1)
                        ...
                        @include('hitexis-admin::catalog.products.edit.images')

                        <!-- Videos View Blade File -->
                        @include('hitexis-admin::catalog.products.edit.videos')
                        ...
                        @include('hitexis-admin::catalog.products.edit.links')
                    ...
                    @else
                        ...
                        @include('hitexis-admin::catalog.products.edit.categories')
                    @endif
                </div>
